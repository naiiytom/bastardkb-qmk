...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_4x6_5(
        KC_MUTE, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_VOLU,       KC_BRID, KC_BRIU, _______, _______, KC_CALC, KC_DEL,
        KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,                   KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,
        KC_LCAP, KC_HOME, KC_PGUP, KC_PGDN, KC_END, _______,        KC_P1, KC_P2, KC_P3, KC_P4, KC_P5, KC_BSLS,
        _______, KC_MYCM, KC_CPNL, _______, _______, _______,       KC_P6, KC_P7, KC_P8, KC_P9, KC_P0, KC_PIPE,
